/**
 * \file convertchainecsp.c
 * \brief Programme de génération des fichiers ListeChaine à partir d'un réseau via Dijkstra avec contraintes
 * \author david
 * \date 28 avr. 2012
 */
...
int main(int argc, char **argv) {
	...
	int i;
	if (argc < 2) {
		leverErreur("Usage : ./convertchainecsp *.res");
		return 1;
	}
	for (i = 1; i < argc; i++) {
